 ...
 * - all clients: the animated ECG hero (GIF; Outlook desktop shows frame 0,
 *   a complete trace);
...
<table role="presentation" class="wrap" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:600px;">
  ...
  <tr><td class="px" style="padding:0 32px;">
    <a href="${site}" style="text-decoration:none;"><img src="${esc(hero)}" width="536" alt="A heartbeat line at 54 BPM: request received" style="display:block;width:100%;max-width:536px;height:auto;border-radius:20px;border:1px solid ${LINE};background:#000;"></a>
  </td></tr>
